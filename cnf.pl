/*
Module      : cnf
Description : Every formula in propositional logic can be transformed into an 
equivalent formula in CNF.
Copyright   : (c) Camilo Andrés Rodríguez Garzón, 2016
License     : GPL-3
Maintainer  : Camilo Andrés Rodríguez Garzón
Stability   : stable
Portability : POSIX

Cnf is a Prolog program intends to provide a solution give one PROP return a
PROP in conjunctive normal form (cnf). 
*/
